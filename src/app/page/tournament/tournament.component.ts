...
import {ProfessionalTournaments} from '../../models/professional-tournaments';
import {HttpProfessionalTournamentService} from '../../services/http-professional-tournament.service';
import {HttpTournamentMoreEnrollmentsService} from '../../services/http-tournament-more-enrollments.service';
import {TournamentMoreEnrollments} from '../../models/tournament-more-enrollments';
@Component({
...
export class TournamentComponent implements OnInit, AfterViewInit {
  ...
  professionalData: ProfessionalTournaments;
  enrollmentData: TournamentMoreEnrollments;
  studentId: number;
  ...
  constructor(private httpFreeTournament: HttpFreeTournamentService, private httpProfessional: HttpProfessionalTournamentService ,
              private  httpEnrollment: HttpTournamentMoreEnrollmentsService , private router: Router, private route: ActivatedRoute) {
    this.freeData = {} as FreeTournament;
    this.professionalData = {} as ProfessionalTournaments;
    this.enrollmentData = {} as TournamentMoreEnrollments;
  }
